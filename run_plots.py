...
parser.add_argument('--base_path', type=list_of_strings, help='List of base paths')
parser.add_argument('--legend_lst', type=list_of_strings, help='List of legends')
...
--base_path "models/17.03.24/maximum_rewards/maximum_rewards_optuna/","another path.. / "
--legend_lst "shira","another-path"
--save_path "models/17.03.24/maximum_rewards/maximum_rewards_optuna/"
"""
args = parser.parse_args()

# Assign the parsed arguments to variables
base_path = args.base_path
legend_lst = args.legend_lst
