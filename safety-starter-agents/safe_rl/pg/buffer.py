...
class CPOBuffer:
    ...
    def __init__(self, size, 
        ...
        self.mask_buf = np.zeros(combined_shape(size, 5), dtype=np.float32)
    ...
    def store(self, obs, act, mask, rew, val, cost, cval, logp, pi_info):
    ...
    def get(self):
        ...
        return [self.obs_buf, self.act_buf, self.mask_buf,self.adv_buf,
